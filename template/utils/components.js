...
const components={
  CustomTable,CustomForm,Row,Col,Panel,Back,
  Button,Form,Item,Input,TextArea,Search,InputNumber,Select,Option,
  Checkbox,CheckboxGroup,Radio,RadioGroup,RadioButton,Switch,DatePicker,RangePicker,TimePicker,TRangePicker,Upload,
  Tabs,TabPane,Tag,Tooltip,Badge,Result,Empty,Space,Progress,Spin,
};
