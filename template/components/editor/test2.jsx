  ...
  return (
    <Slate editor={editor} value={value} onChange={value => setValue(value)}>
      <Toolbar>
        ...
        <BlockButton format="heading-one" icon="FieldBinaryOutlined" />
        <BlockButton format="heading-two" icon="SortDescendingOutlined" />
        <BlockButton format="block-quote" icon="InteractionOutlined" />
