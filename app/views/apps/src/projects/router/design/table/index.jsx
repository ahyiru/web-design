...
const TableEditor = props => {
  const {data = {}, getValues, designConfigText, actionsText = {}, addFormText = {}} = props;
  ...
  return (
    <>
      ...
      <FormEditor getValues={getSearchForm} data={data.searchSchema} editorI18n={editorI18n} actionsText={actionsText} addFormText={addFormText} />
      <Divider dashed style={{borderColor: 'rgba(255,255,255,.1)'}} />
      ...
      <FormEditor getValues={getModalForm} data={data.modalSchema} editorI18n={editorI18n} actionsText={actionsText} addFormText={addFormText} />
    </>
  );
};
