        ...
        <Col>
          <Panel>
            ...
            <div style={{marginTop: 10}}>
              ...
              <Switch
                checkedChildren={i18nCfg.checkedChildren}
                unCheckedChildren={i18nCfg.unCheckedChildren}
                checked={menuType === 'horizontal'}
                onChange={(type) => {
                  setMenuType(type ? 'horizontal' : 'vertical');
                }}
              />
            </div>
            <div style={{marginTop: 10}}>
          ...
          <Row>
            <Col span={6}>
              <Panel>
                ...
                {sizes.map((v) => (
                  <Row key={v.key} style={{marginTop: 8}}>
                    <Col span={4}>
                      <span style={labelStyle}>{themeLang[v.key]}：</span>
                    </Col>
                    <Col span={6}>
                      <Input disabled={v.key === '--topbarHeight'} type={v.type} value={v.value} onChange={(e) => changeTheme(e, v)} />
                    </Col>
                  </Row>
                ))}
              </Panel>
