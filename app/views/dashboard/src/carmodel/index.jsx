...
const ItemHeader = ({index}) => {
  ...
  return <div className="model-item-header">
    <h3>{name}</h3>
    {score ? <div className="model-rate-score"><RateScore score={score} style={{fontSize: '1.8rem'}}>★★★★★</RateScore></div> : null}
  </div>;
};

const CarDashboard = props => {
  return <div className="car-model-dashboard">
