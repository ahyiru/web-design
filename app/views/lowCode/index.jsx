...
const Index=props=>{
  ...
  return <div>
    <div style={{overflow:'hidden',marginBottom:10}}>
      <Button onClick={e=>props.router.push({path:'/apps/projects/router/6098f12b099e1202a287acad',params:{name,_id:id,key,path:key}})} type="link" size="small" style={{float:'right'}}>{pageText.design_text}</Button>
    </div>
