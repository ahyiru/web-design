...
export const NodePopover = ({ children, status }) => {
  ...
  return (<Popover placement="bottomLeft" content={<PopoverContent status={status}/>} overlayClassName={css.content}>
    {componentNode}
  </Popover>);
};
const nodeAtts = {
...
const PopoverContent = ({ status }) => (<ul className={css.list}>
