...
import { useExperimentGraph, useUnmountExperimentGraph } from '@app/views/commons/x6-demo/pages/rx-models/experiment-graph';
...
export const DAGCanvas = (props) => {
  ...
  return (<div className={`${styles.dagContainer} ${className}`}>
