...
import initStart from '../canvas/handleEvts';

const {debounce,getTouchPosition,getRelative,getViewportSize}=utils;
...
export const init=ref=>initStart(ref,startEvent,moveEvent,endEvent);
